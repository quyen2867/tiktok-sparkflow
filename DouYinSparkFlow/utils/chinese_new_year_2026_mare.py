...
# Kho lời chúc Tết Bính Ngọ 2026 (mỗi ngày 30+ mẫu)
# Đặc điểm: dùng chung mọi ngữ cảnh, không kén đối tượng, bám sát từng ngày Tết
# GHI CHÚ: Phần lời chúc bên dưới vẫn là mẫu tiếng Trung cũ (data gửi tin).
# Code/comment đã Việt hóa. Mặc định tính năng này TẮT (happyNewYear.enabled=false),
# bạn nên dùng messageTemplate tiếng Việt "Giữ chuỗi nhé 🔥" của mình.
# Nếu muốn dịch toàn bộ 600+ lời chúc sang lời chúc Tết Việt, báo mình dịch riêng.
SPRING_FESTIVAL_QUOTES = {
    # ==============================================
    # 16/02/2026 Giao thừa (30 Tết)
    # Chủ đề: tiễn năm cũ, đoàn viên, đón giao thừa, cơm tất niên
    # ==============================================
    date(2026, 2, 16): [
        # Phần tiễn cũ đón mới
    ...
    # Chủ đề: mở cửa đón lộc, chúc Tết, năm mới, tinh thần mã đáo
    # ==============================================
    date(2026, 2, 17): [
        # Phần mở cửa đón lộc
    ...
    # ==============================================
    # 18/02/2026 Mùng 2 Tết (về nhà ngoại)
    # Chủ đề: về nhà, tình thân, sum họp, phúc đầy nhà
    # ==============================================
    date(2026, 2, 18): [
        # Phần về nhà sum họp
    ...
    # ==============================================
    # 19/02/2026 Mùng 3 Tết (ngày nghỉ ngơi)
    # Chủ đề: nghỉ ngơi, dưỡng sức, ở nhà
    # ==============================================
    date(2026, 2, 19): [
        # Phần ở nhà nghỉ ngơi
    ...
    # ==============================================
    # 20/02/2026 Mùng 4 Tết (đón Táo quân)
    # Chủ đề: bếp lửa, cơm no, nhà cửa sung túc
    # ==============================================
    date(2026, 2, 20): [
        # Phần đón Táo quân
    ...
    # ==============================================
    # 21/02/2026 Mùng 5 Tết (đón Thần Tài)
    # Chủ đề: tài lộc, tiễn nghèo, phát tài
    # ==============================================
    date(2026, 2, 21): [
        # Phần đón tài lộc
    ...
    # ==============================================
    # 22/02/2026 Mùng 6 Tết (khai trương)
    # Chủ đề: hanh thông, khai trương, thuận lợi
    # ==============================================
    date(2026, 2, 22): [
        # Phần lục lục đại thuận
    ...
    # ==============================================
    # 23/02/2026 Mùng 7 Tết (ngày của mọi người)
    # Chủ đề: sức khỏe, trưởng thành
    # ==============================================
    date(2026, 2, 23): [
        # Phần ngày chung mọi người
    ...
    # ==============================================
    # 24/02/2026 Mùng 8 Tết (ngày làm việc)
    # Chủ đề: cày cấy, bội thu, sự nghiệp, khởi hành
    # ==============================================
    date(2026, 2, 24): [
        # Phần khai việc khởi hành
    ...
    # ==============================================
    # 25/02/2026 Mùng 9 Tết (vía Trời)
    # Chủ đề: trường cửu, cầu phúc, chí cao
    # ==============================================
    date(2026, 2, 25): [
        # Phần vía Trời
        "正月初九，天公生。愿上天庇佑，阖家安康。",
    ...
    # ==============================================
    # 26/02/2026 Mùng 10 Tết (thập toàn thập mỹ)
    # Chủ đề: viên mãn, vững chắc, thập toàn
    # ==============================================
    date(2026, 2, 26): [
        # Phần thập toàn thập mỹ
    ...
    # ==============================================
    # 27/02/2026 11 Tết (tiệc họp mặt)
    # Chủ đề: gặp gỡ, tình nghĩa, đãi khách
    # ==============================================
    date(2026, 2, 27): [
        # Phần tiệc sum họp
    ...
    # ==============================================
    # 28/02/2026 12 Tết (chuẩn bị Rằm)
    # Chủ đề: hâm nóng, ánh sáng, mong chờ
    # ==============================================
    date(2026, 2, 28): [
        # Phần dựng đèn đón Rằm
    ...
    # ==============================================
    # 01/03/2026 13 Tết (thử đèn hoa)
    # Chủ đề: thử đèn, rực rỡ, lãng mạn
    # ==============================================
    date(2026, 3, 1): [
        # Phần thử đèn
    ...
    # ==============================================
    # 02/03/2026 14 Tết (trước Rằm)
    # Chủ đề: chờ trăng tròn, bịn rịn
    # ==============================================
    date(2026, 3, 2): [
        # Phần chờ trăng tròn
...
lunar_calendar = {
    date(2026, 2, 16): "Giao thừa",
    date(2026, 2, 17): "Mùng 1 Tết",
    date(2026, 2, 18): "Mùng 2 Tết",
    date(2026, 2, 19): "Mùng 3 Tết",
    date(2026, 2, 20): "Mùng 4 Tết",
    date(2026, 2, 21): "Mùng 5 Tết",
    date(2026, 2, 22): "Mùng 6 Tết",
    date(2026, 2, 23): "Mùng 7 Tết",
    date(2026, 2, 24): "Mùng 8 Tết",
    date(2026, 2, 25): "Mùng 9 Tết",
    date(2026, 2, 26): "Mùng 10 Tết",
    date(2026, 2, 27): "11 Tết",
    date(2026, 2, 28): "12 Tết",
    date(2026, 3, 1): "13 Tết",
    date(2026, 3, 2): "14 Tết",
    date(2026, 3, 3): "Rằm tháng Giêng"
}

def get_lunar_date(gregorian_date):
    """
    Lấy ngày âm lịch tương ứng từ ngày dương lịch
    Tham số: gregorian_date - đối tượng datetime.date
    Trả về: str - chuỗi ngày âm; None - ngày ngoài phạm vi
    """
    return lunar_calendar.get(gregorian_date, None)

def get_random_festival_quote():
    """
    Lấy ngẫu nhiên một lời chúc từ SPRING_FESTIVAL_QUOTES theo ngày hiện tại
    Trả về: str - lời chúc ngẫu nhiên; None - ngày hiện tại không có lời chúc
    """
    # Lấy ngày hệ thống hiện tại
    today = date.today()
    
    # 1. Kiểm tra ngày hiện tại có trong kho lời chúc không
    if today in SPRING_FESTIVAL_QUOTES:
        # 2. Lấy danh sách lời chúc của ngày đó
        daily_quotes = SPRING_FESTIVAL_QUOTES[today]
        # 3. Chọn ngẫu nhiên một lời chúc
        random_quote = random.choice(daily_quotes)
        return random_quote
    else:
        # Nếu ngày hiện tại không có lời chúc, trả về gợi ý
        return f"Hôm nay ({today.strftime('%d/%m/%Y')}) chưa có lời chúc Tết riêng"
